...
class Observable:
    ...
    def obsAjouterObservateur(self, observateur, nomAttribut, transmissionImmediate=False):
        ...
        if isinstance(observateur, Observateur) is True and nomAttribut in self._obsObservateurs.keys():
            ...
            if transmissionImmediate:
                self.obsOnMiseAJour(nomAttribut, getattr(self, nomAttribut))
            return True
        else:
            return False
    ...
    def obsSupprimerObservateur(self, observateur, nomAttribut):
        ...
        Si <transmissionImmediate> vaut <True>, une observation initiale sera faite."""
        if isinstance(observateur, Observateur) is True and nomAttribut in self._obsObservateurs.keys():
